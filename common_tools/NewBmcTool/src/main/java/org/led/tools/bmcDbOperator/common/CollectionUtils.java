...
public abstract class CollectionUtils {
    ...
    /**
     * get all the field values of the collection elements
     * 
     * @param collection
     * @param fieldName
     * @return
     */
    @SuppressWarnings("unchecked")
    public static <T1, T2> List<T2> getAllFieldValues(Collection<T1> collection, String fieldName) {
        List<T2> fieldValues = getList();
        if (!isEmpty(collection)) {
            Method getterMethod = getMethod(collection.iterator().next().getClass(), getMethodNameByFieldName(fieldName));
            if (getterMethod != null) {
                for (T1 element : collection) {
                    fieldValues.add((T2) getFieldValue(element, getterMethod));
                }
            }
        }
        return fieldValues;
    ...
    /**
     * get the filed value by invoking getter method
     * 
     * @param object
     *            the object which you want to get field value from
     * @param fieldName
     *            the field name that you want to get value
     * @return
     */
    public static <T> T getFieldValue(Object object, String fieldName) {
        ...
        try {
            ...
            Method getterMethod = getMethod(object.getClass(), getMethodNameByFieldName(fieldName));
            if (getterMethod != null) {
                return getFieldValue(object, getterMethod);
            }
    ...
    @SuppressWarnings("unchecked")
    public static <T> T getFieldValue(Object object, Method method) {
    ...
    /**
     * get method from given Class object with given methodName and parameterTypes
     * 
     * @param clazz
     * @param methodName
