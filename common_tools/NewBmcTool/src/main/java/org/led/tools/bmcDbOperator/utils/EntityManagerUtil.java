...
public class EntityManagerUtil {
	...
	private static String persistenceUnit = "haha";
	private static String name = "bmc";
	...
	private static Map<String, String> getDbPropsForPostgres() {
	    if(ConfigLoader.getValue("jdbc_driver") == null) {
	        System.out.println("Config file cannot be loaded.");
	    }
	...
	public static synchronized EntityManagerFactory getEntityManagerFactory() {
		if (entityManagerFactory == null) {
			entityManagerFactory = Persistence.createEntityManagerFactory(persistenceUnit, getDbPropsForPostgres());
		}
